...
@section('contenido')
    <div class="flex justify-center items-center h-screen bg-gray-100">
        <div class="bg-white p-8 rounded-lg shadow-md w-96">
            <h2 class="text-2xl font-semibold mb-6">Crea tu cuenta</h2>
            ...
            <form method="post" action="/register">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" class="border p-3 w-full rounded-lg focus:outline-none focus:border-blue-500" placeholder="Ingrese su nombre" value="{{ old('name') }}">
                    @error('name')
